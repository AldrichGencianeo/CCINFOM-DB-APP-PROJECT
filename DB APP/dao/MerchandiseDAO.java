...
public class MerchandiseDAO {
    ...
    public List<Event> getRelatedEvents(int merchandiseID) throws SQLException {
        ...
        String query = """
                SELECT e.eventID, e.eventname, e.eventtype, e.bookingfee
                FROM event_merch em
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            while (resultSet.next()) {
                Event event = new Event(resultSet.getInt("eventID"), resultSet.getString("eventname"), resultSet.getString("eventtype"), resultSet.getDouble("bookingfee"));
                events.add(event);
            }
        }
